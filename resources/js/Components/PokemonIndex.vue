...
<!--        />-->
    ...
    <div v-if="pokemonsLength">
        <section  class="mt-10 p-4 grid grid-cols-3 justify-center">
            ...
            >
                <div class="grid w-full grid-cols-1 gap-2 mx-auto">
                    <div class="p-6 items-center justify-center">
                        ...
                        <a
                            href="#"
                            @click="triggerAbility(pokemon.abilities)"
                            class="text-sm text-pink-700"
                            @closeAbility="triggerAbility"
                        >Abilities: {{ pokemon.abilities.length }}</a>
                        <div class="mt-4">
                            <a
                                href="#"
            ...
            <abilities :show-ability="showAbility" :abilities="abilitiesShowSet" @closeAbility="triggerAbility"></abilities>
        </section>
    </div>
...
export default {
    name: 'Home',
    components: {Pagination, Abilities},
    setup() {
        ...
        function triggerAbility(abilities) {
            if (!state.showAbility) {
                state.abilitiesShowSet = abilities;
            }
            state.showAbility = !state.showAbility;
        }
